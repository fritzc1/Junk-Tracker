#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
#:
#: Automatic Install script for Junk Tracker (Linux).
#:
...
echo "============================================"
echo "Junk Tracker — Install Script (Linux)"
echo "============================================"
echo ""
...
if ! command -v node &> /dev/null; then
    ...
    echo "  or run: curl -fsSL https://deb.nodesource.com/setup_lts.x | sudo -E bash -"
...
if [ -f "./MongoDB/bin/mongod" ]; then
    ...
    wget -O mdb.tgz http://downloads.mongodb.org/linux/mongodb-linux-x86_64-ubuntu2004-latest.tgz
    rm -rf "MongoDB/_temp"
